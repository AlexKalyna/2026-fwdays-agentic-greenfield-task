...
| # | Capability   | Suggested change name        | PRD requirements                          | Depends on           |
| - | ------------ | ---------------------------- | ----------------------------------------- | -------------------- |
| 1 | `foundation` | `add-bot-foundation`         | TC-STACK-01..03, TC-DEPLOY-01, NFR-OPS-01, NFR-REL-01, FR-SEC-01, FR-SEC-02 | — |
| 2 | `weigh-in`   | `add-weigh-in-logging`       | FR-LOG-01..08                             | foundation           |
| 3 | `compare`    | `add-entry-comparisons`      | FR-CMP-01..04                             | weigh-in             |
| 4 | `trends`     | `add-trend-labels`           | FR-TREND-01..03                           | compare              |
| 5 | `messaging`  | `add-supportive-messaging`   | FR-MSG-01..08, BC-TONE-01                 | trends               |
| 6 | `history`    | `add-history-views`          | FR-HIST-01..09, NFR-TZ-01                 | trends, messaging    |
| 7 | `settings`   | `add-settings-command`       | FR-SET-01..03                             | foundation           |
| 8 | `onboarding` | `add-onboarding-flow`        | FR-ONB-01..05, FR-CMD-02                  | settings, weigh-in   |
| 9 | `reminders`  | `add-sunday-reminders`       | FR-REM-01..03, NFR-TZ-01                  | settings, onboarding |
| 10 | `commands`  | `add-command-surface-polish` | FR-CMD-01                                 | all above            |
